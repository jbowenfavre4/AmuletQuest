...
public class CommonEssence implements Essence {

    private Attribute attribute;
    private ChatColor rarityColor = ChatColor.GREEN;
    ...
    public void produceItem() {
        ...
        switch (this.attribute) {
            case GENERIC_ARMOR:
                meta.setDisplayName(rarityColor + "Common essence of armor");
                lore.add("to provide a small boost to armor");
                attribute = "armor";
                break;
            case GENERIC_MAX_HEALTH:
                meta.setDisplayName(rarityColor + "Common essence of health");
                lore.add("to provide a small health increase");
                attribute = "health";
                break;
            case GENERIC_MOVEMENT_SPEED:
                meta.setDisplayName(rarityColor + "Common essence of speed");
                lore.add("to provide a small boost to movement speed");
                attribute = "speed";
                break;
            case GENERIC_ATTACK_DAMAGE:
                meta.setDisplayName(rarityColor + "Common essence of strength");
                lore.add("to increase attack damage");
                attribute = "strength";
                break;
            default:
                meta.setDisplayName(rarityColor + "Common essence of knockback");

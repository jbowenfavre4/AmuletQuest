...
public class RareEssence implements Essence {

    private ChatColor rarityColor = ChatColor.BLUE;
    ...
    public void produceItem() {
        ...
        switch (this.attribute) {
            case GENERIC_ARMOR:
                meta.setDisplayName(rarityColor + "Rare essence of armor");
                lore.add("to provide a boost to armor");
                attribute = "armor";
                break;
            case GENERIC_MAX_HEALTH:
                meta.setDisplayName(rarityColor + "Rare essence of health");
                lore.add("to provide a small health increase");
                attribute = "health";
                break;
            case GENERIC_MOVEMENT_SPEED:
                meta.setDisplayName(rarityColor + "Rare essence of speed");
                lore.add("to provide a small boost to movement speed");
                attribute = "speed";
                break;
            case GENERIC_ATTACK_DAMAGE:
                meta.setDisplayName(rarityColor + "Rare essence of strength");
                lore.add("to increase attack damage");
                attribute = "strength";
                break;
            default:
                meta.setDisplayName(rarityColor + "Rare essence of knockback");
